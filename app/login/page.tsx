...
const Login = () => {
  ...
  return (
    <div className="font-sans inline-flex items-center justify-center min-h-screen min-w-screen bg-linear-to-t from-blue-600 to-fuchsia-500">
        <form onSubmit={handleLogin} className='flex flex-col items-center justify-center bg-stone-50 rounded-3xl shadow-lg px-6 py-8 w-1/4 h-max'>
            ...
            <button className='bg-fuchsia-500 px-9 py-4 my-4 w-96 rounded-2xl text-white text-1xl font-bold' type="submit" disabled={loading}>{loading ? "Logging in..." : "LOGIN"}</button>
            <Link href="/signup" className="text-blue-400 hover:underline mt-4 text-right">
